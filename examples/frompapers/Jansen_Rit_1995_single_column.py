...
defaultclock.dt = 0.1 * ms  # default time step

te, ti = 10.0 * ms, 20.0 * ms  # taus for excitatory and inhibitory populations
e0 = 5.0  # max firing rate
v0 = 6.0  # (max FR)/2 input
r0 = 0.56  # gain rate
A, B, C = 3.25, 22.0, 135  # standard parameters as in the set (7) of the original paper
P, deltaP = 120, 320.0 - 120  # random input uniformly distributed between 120 and
...
n = NeuronGroup(
    6, equs, method="euler"
)  # creates 6 JR models for different connectivity parameters
