...
# Monitors
################################################################################
syn_mon = StateMonitor(synapses, "r_S", record=np.arange(N_synapses * (N_astro + 1)))
...
ax[1].set(
    xlim=(0.08, 100), xscale="log", ylim=(0.0, 0.7), ylabel=r"$\langle r_S \rangle$"
)
...
ax[2].set(
    xlim=(0.08, 100), xscale="log", ylim=(0.0, 0.2), ylabel=r"$\langle r_S \rangle$"
)
