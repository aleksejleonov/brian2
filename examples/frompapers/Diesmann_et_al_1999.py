...
Pinput = SpikeGeneratorGroup(85, np.arange(85), np.random.randn(85) * 1 * ms + 50 * ms)
# The network structure
S = Synapses(P, P, on_pre="y+=weight")
S.connect(
    j="k for k in range((int(i/group_size)+1)*group_size, (int(i/group_size)+2)*group_size) "
